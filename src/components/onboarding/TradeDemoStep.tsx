  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-fdp-text-1 mb-2">See How It Works</h1>
        <p className="text-lg text-fdp-text-2">Interactive trade calculator demo</p>
      </div>

      {step === 0 && (
        <div className="bg-fdp-surface-1 rounded-lg shadow-lg p-8">
          <h2 className="text-2xl font-bold text-fdp-text-1 mb-6">Example Trade</h2>
      ...
      {step === 1 && (
        <div className="bg-fdp-surface-1 rounded-lg shadow-lg p-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div>
              <h3 className="font-semibold text-fdp-text-1 mb-3">Value Analysis</h3>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-fdp-text-2">You Give:</span>
                  <span className="font-semibold">5,000</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-fdp-text-2">You Receive:</span>
                  <span className="font-semibold">5,200</span>
                </div>
                <div className="flex justify-between pt-2 border-t">
                  <span className="text-fdp-text-2">Net Gain:</span>
            ...
            <div>
              <h3 className="font-semibold text-fdp-text-1 mb-3">Team Fit</h3>
              <div className="space-y-2">
                <FitBadge
      ...
      {step === 2 && (
        <div className="bg-fdp-surface-1 rounded-lg shadow-lg p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-fdp-text-1 mb-2">You're Ready!</h2>
          <p className="text-fdp-text-2 mb-8">
            Now you understand how league-aware values work
          </p>

          <div className="bg-fdp-surface-1 rounded-lg p-6 mb-8 text-left">
            <h3 className="font-semibold text-fdp-text-1 mb-3">Remember:</h3>
            <ul className="space-y-2 text-fdp-text-1">
...
function PlayerCard({ name, position, value }: { name: string; position: string; value: number }) {
  return (
    <div className="flex items-center justify-between p-3 bg-fdp-surface-1 rounded border border-fdp-border-1">
      <div>
        <div className="font-semibold text-fdp-text-1">{name}</div>
        <div className="text-sm text-fdp-text-2">{position}</div>
      </div>
      <div className="font-bold text-fdp-text-1">{value.toLocaleString()}</div>
    </div>
  );
}
