  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="bg-fdp-surface-1 rounded-lg shadow-lg p-12 text-center">
        ...
        <h1 className="text-4xl font-bold text-fdp-text-1 mb-2">You're Ready!</h1>
        <p className="text-xl text-fdp-text-2 mb-12">
      ...
      {/* What's Next */}
      <div className="mt-8 bg-fdp-surface-1 rounded-lg shadow p-6">
        <h3 className="font-semibold text-fdp-text-1 mb-3">What to explore next:</h3>
        <ul className="space-y-2 text-sm text-fdp-text-1">
    ...
    <div className="flex items-start gap-4 p-4 bg-fdp-surface-1 rounded-lg">
      ...
      <div className="flex-1">
        <div className="flex items-center gap-2 mb-1">
          <span className="text-2xl font-bold text-fdp-text-1">{count}</span>
          <span className="font-semibold text-fdp-text-1">{label}</span>
        </div>
