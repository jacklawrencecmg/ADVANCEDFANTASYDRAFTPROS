      ...
      <button
        ...
        className={`p-2 rounded-lg transition-all ${
          isWatching
            ...
            : 'text-fdp-text-3 hover:text-yellow-500 bg-fdp-surface-1 hover:bg-yellow-50'
      ...
      <button
        ...
        className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-semibold transition-all ${
          isWatching
            ...
            : 'text-fdp-text-1 bg-fdp-surface-1 hover:bg-fdp-surface-2 border border-fdp-border-1'
        } ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
      >
        {loading ? (
    ...
    <button
      ...
      className={`flex items-center gap-2 px-4 py-2 rounded-lg font-semibold transition-all ${
        isWatching
          ...
          : 'text-fdp-text-1 bg-fdp-surface-1 hover:bg-fdp-surface-1 border-2 border-fdp-border-1 hover:border-yellow-300'
      } ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
    >
      {loading ? (
        <>
