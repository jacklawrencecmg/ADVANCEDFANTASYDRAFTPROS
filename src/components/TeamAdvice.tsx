...
export default function TeamAdvice({ leagueId, sleeperLeagueId, rosterId }: TeamAdviceProps) {
  ...
  if (loading) {
    return (
      <div className="bg-fdp-surface-1 rounded-lg shadow-sm p-8 text-center">
        ...
        <p className="text-fdp-text-2">Analyzing your team strategy...</p>
      </div>
    );
  }
  ...
  if (!strategy) {
    return (
      <div className="bg-fdp-surface-1 border border-fdp-border-1 rounded-lg p-6 text-center">
        <Target className="w-12 h-12 text-fdp-text-3 mx-auto mb-3" />
        <p className="text-fdp-text-2">No strategy data available</p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className={`bg-gradient-to-r ${config.bgGradient} rounded-lg shadow-lg p-6 text-white`}>
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            disabled={refreshing}
            className="flex items-center gap-2 bg-fdp-surface-1/20 hover:bg-fdp-surface-1/30 px-4 py-2 rounded-lg transition-colors disabled:opacity-50"
          >
        ...
        <div className="mt-4">
          ...
          <div className="w-full bg-fdp-surface-1/20 rounded-full h-3">
            <div
              className="bg-fdp-surface-1 rounded-full h-3 transition-all duration-500"
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-fdp-surface-1 rounded-lg border border-fdp-border-1 p-4">
          <div className="flex items-center gap-2 text-fdp-text-2 mb-1">
          ...
          <div className="text-xs text-fdp-text-3 mt-1">percentile</div>
        </div>
        ...
        <div className="bg-fdp-surface-1 rounded-lg border border-fdp-border-1 p-4">
          ...
          <div className="text-xs text-fdp-text-3 mt-1">FDP value</div>
        </div>
        ...
        <div className="bg-fdp-surface-1 rounded-lg border border-fdp-border-1 p-4">
          ...
          <div className="text-xs text-fdp-text-3 mt-1">youth (≤24)</div>
        </div>
        ...
        <div className="bg-fdp-surface-1 rounded-lg border border-fdp-border-1 p-4">
          ...
          <div className="text-xs text-fdp-text-3 mt-1">veterans</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-fdp-surface-1 rounded-lg border border-fdp-border-1 p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-lg font-bold text-fdp-text-1">Strengths</h3>
          </div>
          {strategy.strengths.length > 0 ? (
            <ul className="space-y-2">
              {strategy.strengths.map((strength, index) => (
                <li key={index} className="flex items-start gap-2 text-fdp-text-1">
            ...
            <p className="text-fdp-text-3 text-sm">No significant strengths identified</p>
          )}
        </div>
        ...
        <div className="bg-fdp-surface-1 rounded-lg border border-fdp-border-1 p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-lg font-bold text-fdp-text-1">Weaknesses</h3>
          </div>
          {strategy.weaknesses.length > 0 ? (
            ...
            <p className="text-fdp-text-3 text-sm">No critical weaknesses identified</p>
          )}
        </div>
      </div>
      ...
      <div className="bg-fdp-surface-1 rounded-lg border border-fdp-border-1 p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-lg font-bold text-fdp-text-1">Recommended Actions</h3>
        </div>
        <div className="space-y-3">
          {strategy.recommendations.map((rec, index) => (
            <div key={index} className="flex items-start gap-3 p-3 bg-blue-50 rounded-lg border border-blue-100">
              ...
              <p className="text-fdp-text-1 flex-1">{rec}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="bg-fdp-surface-1 rounded-lg border border-fdp-border-1 p-6">
        <h3 className="text-lg font-bold text-fdp-text-1 mb-4">Positional Rankings</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {Object.entries(strategy.metrics.positional_scores)
            ...
            .map(([position, score]) => {
              ...
              const textColor = isStrength ? 'text-green-700' : isWeakness ? 'text-red-700' : 'text-fdp-text-1';
      ...
      {strategy.calculated_at && (
        <div className="text-center text-sm text-fdp-text-3">
